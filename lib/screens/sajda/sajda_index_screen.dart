...
class SajdaIndexScreen extends StatefulWidget {
  const SajdaIndexScreen({Key? key}) : super(key: key);

  @override
  State<SajdaIndexScreen> createState() => _SajdaIndexScreenState();
}

class _SajdaIndexScreenState extends State<SajdaIndexScreen> {
